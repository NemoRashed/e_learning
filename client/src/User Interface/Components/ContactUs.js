    ...
    <div>
      <section class="text-gray-600 body-font ">
        <div class=" w-full px-20 py-24 sm:px-5  mx-auto flex sm:flex-wrap flex-wrap justify-between">
          <div class="lg:w-1/2 sm:w-full bg-gray-800 rounded-lg overflow-hidden  p-10 flex items-end justify-start relative">
            <img className="absolute inset-0 w-full h-screen" src="map.jpg" />

            <div class="bg-orange-200  w-full relative flex justify-between items-center sm:flex-wrap py-6 rounded shadow-md">
          ...
          <div class="lg:w-1/3 sm:w-full  bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
            ...
            <div class="relative mb-4">
              ...
              <input
                ...
                id="name"
                name="name"
                class="w-full bg-orange-100 rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
              />
            </div>
            <div class="relative mb-4">
            ...
            <div class="relative mb-4">
              ...
              <textarea
                id="message"
                name="message"
                class="w-full bg-orange-100 rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"
              ></textarea>
            </div>
            <button class="text-white somaliland-gradient border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">
              Submit
            </button>
          </div>
        </div>

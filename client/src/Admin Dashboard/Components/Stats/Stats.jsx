...
<div className='hover:scale-110 transition duration-300 ease-in-out'>
        ...
        <div className="rounded-lg hover:shadow-lg h-full block bg-white">
          ...
          <div className="p-6">
            <h3 className="text-2xl font-bold text-primary bg-green-200 rounded-md mb-4">1000</h3>
            <h5 className="text-lg font-medium mb-4">Students</h5>
...
<div className='hover:scale-110 transition duration-300 ease-in-out'>
        <div className="rounded-lg hover:shadow-lg h-full block bg-white">
          ...
          <div className="p-6">
            <h3 className="text-2xl font-bold text-primary bg-orange-200 rounded-md mb-4">70%</h3>
            <h5 className="text-lg font-medium mb-4">Graphs</h5>
            <p className="text-gray-500">
      ...
      <div className="">
        ...
        <div className="rounded-lg  hover:shadow-lg h-full block bg-white">
          ...
          <div className="p-6">
            <h3 className="text-2xl font-bold text-primary bg-blue-200 rounded-md mb-4">49</h3>
            <h5 className="text-lg font-medium mb-4">Lectures</h5>
            <p className="text-gray-500">

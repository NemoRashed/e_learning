...
function Mylearning() {
  return (
    <div className="md:px-5">
      <div className="w-full h-96 md:h-full  shadow rounded-lg px-10 py-5 md:px-4  md:py-5 mt-7 ">
        <div className="px-5 py-2 flex justify-between ">
          <p className="text-xl font-bold md:text-lg md:mb-5 ">My Learning</p>
          <Link to="/Courses">
            {" "}
            <p className="text-green-500 text-md">see all</p>
          </Link>
        </div>
        <div className="flex flex-row  md:flex-col justify-between md:justify-center md:items-center">
          <div className="bg-white shadow w-64  md:w-full h-72 rounded-lg md:mb-5  ">
          ...
          <div className="bg-white shadow w-64 h-72 rounded-lg md:mb-5  ">
            <div class="w-full h-32   mb-6 md:mr-5 flex-shrink-0 flex flex-row justify-center items-center student-gradient rounded-lg">

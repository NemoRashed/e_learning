...
function Contact() {
  return (
    <div className="flex flex-col pl-72 pr-10 ">
      <User name={"Contact Us"} />
      <div className="w-full h-20 bg-green-50 rounded-md flex flex-col  px-16 py-4 mx-10 mt-5">
        <p className="flex items-center">
          <img src="/phone.png" className="w-10 h-10 mr-3" />
          Please contact us by email if you encounter any errors or have any
          questions.
        </p>
      </div>
      <div>
        <form className="px-40 py-5">
          <div className="mb-4">
            <label

  ...
  return (
    <div className="flex flex-col pl-72   ">
      ...
      <div className="w-full  px-20 mt-5 ">
        <div class="w-[50rem]    h-52 md:h-44 mb-6   md:mr-5  flex-shrink-0 flex flex-row justify-center items-center student-gradient rounded-lg">
        ...
        <div className="text-md w-full px-14   ">
          <p className="mb-9">
